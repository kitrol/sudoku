...
class LevelSelectPopup(PB.PopupBase):
	...
	def initBtns(self):
		...
		for level in range(0,4):
			...
			levelBtn = BB.ButtonBase("btn_1.png",self.background_,self.onCloseClicked,callbackData=level,btnLabelStr=levelStr[level]);
			levelBtn.showBtn(btnPos[level]);
	...
	def initBg(self):
		...
		self.background_.blit(backg2,rectObj);
